...
public partial class UcPreviousInvoice : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["dir"].ToString() == "ltr")
        {
            ...
            GridView1.Columns[5].HeaderText = String.Format(global::Resources.ResourceMain.InvoiceNo);
            GridView1.Columns[3].HeaderText = String.Format(global::Resources.ResourceMain.InvoiceDate);
            GridView1.Columns[4].HeaderText = String.Format(global::Resources.ResourceMain.InvoiceTotal);
            GridView1.Columns[2].HeaderText = String.Format(global::Resources.ResourceMain.Notes);
        ...
        else
        {
            ...
            GridView1.Columns[5].HeaderText = String.Format(global::Resources.ResourceMain_Ar.InvoiceNo);
            GridView1.Columns[3].HeaderText = String.Format(global::Resources.ResourceMain_Ar.InvoiceDate);
            GridView1.Columns[4].HeaderText = String.Format(global::Resources.ResourceMain_Ar.InvoiceTotal);
            GridView1.Columns[2].HeaderText = String.Format(global::Resources.ResourceMain_Ar.Notes);
