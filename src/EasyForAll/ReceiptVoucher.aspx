<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReceiptVoucher.aspx.cs" Inherits="ReceiptVoucher" %>
        ...
        <ContentTemplate>
           <div class="main" style="font-family:Noor, Tahoma, Geneva, Verdana, sans-serif">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div>
                            <asp:Label ID="LabelPaymentType" runat="server" CssClass="Lbl" Text="Receipt Type "></asp:Label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div>
                                ...
                                <asp:Label ID="LabelReceiptType" runat="server" CssClass="Lbl" Text="Payment Type"></asp:Label>
                            </div>
