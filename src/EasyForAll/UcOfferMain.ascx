<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UcOfferMain.ascx.cs" Inherits="UcOfferMain" %>
                            ...
                            <ItemTemplate>
                               ...
                               <div class="main" style="font-family:Noor, Tahoma, Geneva, Verdana, sans-serif">
                                    <div class="row">
                                           ...
                                           <a href='<%# Eval("ItemId", "DisplayItemsByCategory.aspx?id={0}") %>'><asp:Image ID="picture" runat="server"  Height="150px" ImageUrl='<%# Eval("ImageURL") %>' Width="120px" /></a>
