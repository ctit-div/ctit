<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InvoiceArchived.aspx.cs" Inherits="InvoiceArchived" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>

<%@ Register Src="~/UcArchivedInvoices.ascx" TagPrefix="uc1" TagName="UcArchivedInvoices" %>
            ...
            <span class="border border-success">
                <div class="main" style="font-family: Noor, Tahoma, Geneva, Verdana, sans-serif">
                    ...
                    <div class="row">
                        ...
                        <uc1:UcArchivedInvoices runat="server" ID="UcArchivedInvoices" />
