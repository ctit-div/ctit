<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DisplayMyOrderd.aspx.cs" Inherits="DisplayMyOrderd" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/UcMyOrders.ascx" TagPrefix="uc1" TagName="UcMyOrders" %>
            ...
            <span class="border border-success">
                <div class="main" style="font-family: Noor, Tahoma, Geneva, Verdana, sans-serif">
                    ...
                    <div class="row">
                        ...
                        <uc1:UcMyOrders runat="server" ID="UcMyOrders" />
