<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PropertiesHierarchy.aspx.cs" Inherits="PropertiesHierarchy" %>
        ...
        <ContentTemplate>
            ...
            <div class="main" style="font-family: Noor, Tahoma, Geneva, Verdana, sans-serif">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            <asp:Label ID="Label2" runat="server" CssClass="Lbl" Text="Properties Hierarchy"></asp:Label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="TxtSearch" CssClass="form-control" placeholder="Search by Property Text" runat="server"></asp:TextBox>
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FinanceConnStr %>" SelectCommand="SELECT * FROM [tCompany] WHERE (([CompanyID] = @CompanyID) AND ([CompanyIDParent] = @CompanyIDParent))">
                            <SelectParameters>
                                <asp:QueryStringParameter DefaultValue="7" Name="CompanyID" QueryStringField="7" Type="Int32" />
                                <asp:QueryStringParameter DefaultValue="0" Name="CompanyIDParent" QueryStringField="0" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:Label ID="Label4" runat="server" CssClass="Lbl" Text="Properties Hierarchy"></asp:Label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div>
                           ...
                           <%-- <asp:TreeView ID="TreeView1" Width="50%" runat="server"  ShowCheckBoxes="All" ShowLines="True" ExpandDepth="6" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged"  OnTreeNodeCheckChanged="TreeView1_TreeNodeCheckChanged" OnTreeNodeExpanded="TreeView1_TreeNodeExpanded">
                                <HoverNodeStyle BackColor="#CCCC00" />
                                <LeafNodeStyle ForeColor="#00CC99" />
                                <NodeStyle ForeColor="#CC6600" />
                                <ParentNodeStyle ForeColor="#3333CC" />
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="pnlTextBoxes" runat="server" Visible="False">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <asp:Label ID="LblGroup" runat="server" CssClass="Lbl" Text="Property Name:"></asp:Label>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <asp:Label ID="LblNodeValue" ForeColor="Green" runat="server" Font-Bold="True" Font-Size="X-Large"></asp:Label>
