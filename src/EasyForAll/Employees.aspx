...
<%@ Register Src="~/UcPropertyCompany.ascx" TagPrefix="uc1" TagName="UcPropertyCompany" %>
    ...
    <asp:UpdatePanel ID="hhh222" runat="server">
        <ContentTemplate>
           <div class="main" style="font-family:Noor, Tahoma, Geneva, Verdana, sans-serif">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <asp:Label ID="Label1" runat="server" Text="معلومات الموظف " CssClass="Title"></asp:Label>
                        &nbsp;(<asp:Label ID="LblStatus" runat="server" Font-Size="Large"></asp:Label>
                        )

                           &nbsp;(<asp:Label ID="LblDepartment" runat="server" Font-Size="Large" ForeColor="#0099FF"></asp:Label>
                        )
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FinanceConnStr %>" SelectCommand="SELECT * FROM View_tUsers WHERE (UserTypeCode = 1) OR (UserTypeCode = 2)"></asp:SqlDataSource>
                ...
                <div class="row">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-12">
                            <uc1:UcPropertyCompany runat="server" ID="UcPropertyCompany" />
                                ...
                                <div class="panel-body">
                                    ...
                                    <asp:GridView ID="GvCompany" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <%--<asp:CommandField ShowSelectButton="True" />--%>
                                            <asp:BoundField DataField="UserId" HeaderText="كود العميل" InsertVisible="False" ReadOnly="True" SortExpression="UserId" />
                                            <asp:BoundField DataField="UserName" HeaderText="اسم العميل" SortExpression="UserName" />
                                            ...
                                            <asp:BoundField DataField="CMPCompanyName" HeaderText="القسم" />
