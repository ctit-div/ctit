<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="ItemInfo.aspx.cs" Inherits="ItemInfo" %>
        ...
        <ContentTemplate>
            ...
            <div class="main" style="font-family: Noor, Tahoma, Geneva, Verdana, sans-serif">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div>
                            <asp:Button ID="BtnSearch" runat="server" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" Text="Get Category" CausesValidation="False" Width="100%" />
                        </div>
                    ...
                    <div class="col-md-3">
                        <div>
                            <asp:Button ID="BtnSearchItem" runat="server" class="btn btn-info btn-sm" Text="Get Item" CausesValidation="False" OnClick="BtnSearchItem_Click" Width="100%" />
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div>
                            <asp:Label ID="Label2" runat="server" CssClass="Lbl" Text="اسم الصنف بالعربي"></asp:Label>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div>
                            <asp:Label ID="LabelLocation" runat="server" CssClass="Lbl" Text="Location"></asp:Label>
                        </div>
                        <asp:TextBox ID="TxtLocation" Text="-" Enabled="true" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                            ControlToValidate="TxtLocation" CssClass="LblMessage"
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div>
                            <asp:Label ID="LabelAveragePrice" runat="server" CssClass="Lbl" Text="Average Price"></asp:Label>
                        </div>
                        <asp:TextBox ID="TxtAveragePrice" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server"
                            ControlToValidate="TxtAveragePrice" CssClass="LblMessage"
                            ErrorMessage="Average Price is required">*</asp:RequiredFieldValidator>

                        <asp:RangeValidator ID="RangeValidator5" runat="server"
                            ControlToValidate="TxtAveragePrice" CssClass="LblMessage" ErrorMessage="must be number"
                            MaximumValue="1000000" MinimumValue="0" Type="Currency">*</asp:RangeValidator>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div>
                            <asp:Label ID="LabelOfferPrice" runat="server" CssClass="Lbl" Text="Offer"></asp:Label>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div>
                            <asp:Label ID="LabelCompanBarcode" runat="server" CssClass="Lbl" Text="Company Barcode"></asp:Label>
                        </div>
                        <asp:TextBox ID="TxtBarcode" runat="server" Text="0" CssClass="form-control"></asp:TextBox>
                    ...
                    <div class="col-md-2">
                        <div>
                            <asp:Label ID="LabelAgentName" runat="server" CssClass="Lbl" Text="Agent Name"></asp:Label>
                        </div>
                        <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" CssClass="form-control">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="DropDownList2" CssClass="LblMessage" ErrorMessage="Agent Name is required">*</asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-2">
                        <div>
                            <asp:Label ID="LabelItemType" runat="server" CssClass="Lbl" Text="Item Type"></asp:Label>
                        </div>
                        <asp:DropDownList ID="DropDownListWeight" runat="server" CssClass="form-control">
                            <asp:ListItem Value="0" Selected="True">Goods</asp:ListItem>
                            <asp:ListItem Value="1">Service</asp:ListItem>
                            <asp:ListItem Value="2">Weight</asp:ListItem>
                            <asp:ListItem Value="3">Compound</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownListWeight" CssClass="LblMessage" ErrorMessage="Item Type is required">*</asp:RequiredFieldValidator>
                    </div>
                    <div class="col-md-2">
                        <div>
