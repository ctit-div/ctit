<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UcTopTen.ascx.cs" Inherits="UcTopTen" %>
        ...
        <span class="border border-success">
           <div class="main" style="font-family:Noor, Tahoma, Geneva, Verdana, sans-serif">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <asp:Label ID="Label1" runat="server" Text="New Arrived Products" CssClass="Title" Visible="true"></asp:Label>
